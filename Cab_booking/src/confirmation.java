...
public class confirmation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(260, 210, 86, 16);

        jLabel3.setText("Name");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(230, 250, 36, 16);

        jLabel4.setText("Phone Number");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(230, 280, 92, 16);

        jLabel5.setText("Rating");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(230, 310, 40, 16);

        jLabel6.setText("Car Number");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(230, 340, 75, 16);

        jLabel7.setText("Car Model");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(230, 370, 63, 16);

        jLabel8.setText("Ride Details");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(650, 210, 75, 16);

        jLabel9.setText("Pickup Point");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(560, 250, 78, 16);

        jLabel10.setText("Drop Point");
        getContentPane().add(jLabel10);
        jLabel10.setBounds(560, 280, 67, 16);

        jLabel11.setText("Fare");
        getContentPane().add(jLabel11);
        jLabel11.setBounds(560, 310, 26, 16);

        jLabel12.setText("Estimated Time");
        getContentPane().add(jLabel12);
        jLabel12.setBounds(560, 340, 97, 16);

        jLabel13.setText("Wallet Balance after Deduction");
        getContentPane().add(jLabel13);
        jLabel13.setBounds(560, 370, 191, 16);
